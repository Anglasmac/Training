...
export const dashboardTabs: readonly DashboardTab[] = [
  {
    ...
    label: 'Clientes',
    description:
      'Número de documento, nombre completo, email, teléfono y dirección.',
  },
  {
    id: 'meals',
    label: 'Combos',
    description:
      'Nombre único, categoría, descripción, precio y disponibilidad.',
  },
  {
    id: 'orders',
    label: 'Pedidos',
    description: 'Documento del cliente, UUID del combo, cantidad y totales.',
  },
] as const;
...
export const dashboardStatsByTab: Record<DashboardTab['id'], DashboardStat[]> =
  {
    customers: [
      ...
      { label: 'Máx. documento', value: 20, detail: 'Incluye tipo y guion' },
      {
        label: 'Máx. dirección',
        value: 500,
        detail: 'Dirección completa de envío',
      },
    ],
    meals: [
